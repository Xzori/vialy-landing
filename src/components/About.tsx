    ...
    <section id="about" className="py-24 bg-white scroll-mt-20">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <div className="inline-block px-4 py-2 bg-[#F37466]/10 rounded-full mb-4">
            <span className="text-[#F37466]">À propos de Vialy</span>
          </div>
          
          <h2 className="text-4xl lg:text-5xl tracking-tight">
            L'app qui transforme tes marches en <span className="text-[#8CC6DC]">aventures personnalisées</span> grâce à l'IA
          </h2>
